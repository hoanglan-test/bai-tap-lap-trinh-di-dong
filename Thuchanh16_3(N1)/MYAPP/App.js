  ...
  return (
    <ScrollView style={{flex:1, backgroundColor:"#f5f5f5"}}>
      ...
      <View style={styles.bannerCard}>
        ...
        <Image
          source={require("./Group 33660.png")}
      ...
      <View style={styles.popularRow}>
        ...
        <View style={styles.foodCard}>
          <Image
            source={require("./Rectangle 33.png")}
            style={styles.foodImg}
          />
  ...
  return (
    <ScrollView style={styles.cartContainer}>
      ...
      <View style={styles.cartHeader}>
        ...
        <Image source={require("./Frame.png")} style={styles.icon} />
      </View>

      {/* MAIN BURGER IMAGE */}
      <View style={styles.mainImageBox}>
        <Image
          source={require("./Rectangle 35.png")}
          style={styles.mainBurger}
        />
        <Image
        source={require("./Group 33663.png")}
        style={styles.discount}
        />
        <Image
          source={require("./Group 33670.png")}
      ...
      <View style={styles.infoCard}>
        ...
        <View style={styles.quantityRow}>
          ...
          <Image source={require("./Group 33665.png")} style={styles.qtyIcon} />
        </View>

        <View style={styles.addressBox}>
          <Image source={require("./Group 33669.png")} style={styles.address} />
            <View style={styles.purpleBox}>
              <Image source={require("./Frame (1).png")} style={styles.smallIcon}/>
            </View>
        </View>

        <View style={styles.paymentRow}>
          <Image source={require("./Group.png")} style={styles.paymentIcon1} />
          <Image source={require("./Group 33671.png")} style={styles.paymentIcon2}/>
        </View>

        <Image source={require("./Group 33667.png")} style={styles.summary} />
...
function ProfileScreen() {
  return (
    ...
    <View style={styles.center}>
      ...
      <Image
        source={require("./Group 33672.png")}
